...
namespace TRUSIRENT.Migrations
{
    ...
    [Migration("20260128161740_AddCartIdToRentalCartItems")]
    partial class AddCartIdToRentalCartItems
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TRUSIRENT.Models.Entities.Rental", b =>
                {
            ...
            modelBuilder.Entity("TRUSIRENT.Models.Entities.RentalCartItem", b =>
                {
                    b.Property<int>("RentalCartItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("RentalCartItemId"));
                    ...
                    b.HasKey("RentalCartItemId");

                    b.HasIndex("VehicleId");

                    b.ToTable("RentalCartItems");
                });

            modelBuilder.Entity("TRUSIRENT.Models.Entities.RentalDetail", b =>
                {
            ...
            modelBuilder.Entity("TRUSIRENT.Models.Entities.Vehicle", b =>
                {
                    b.Property<int>("VehicleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TRUSIRENT.Models.Entities.VehicleType", b =>
                {
                    b.Property<int>("VehicleTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TRUSIRENT.Models.Entities.RentalCartItem", b =>
                {
                    b.HasOne("TRUSIRENT.Models.Entities.Vehicle", "Vehicle")
                        .WithMany()
            ...
            modelBuilder.Entity("TRUSIRENT.Models.Entities.RentalDetail", b =>
                {
                    b.HasOne("TRUSIRENT.Models.Entities.Rental", "Rental")
            ...
            modelBuilder.Entity("TRUSIRENT.Models.Entities.Vehicle", b =>
                {
                    b.HasOne("TRUSIRENT.Models.Entities.VehicleType", "VehicleType")
                        .WithMany("Vehicles")
